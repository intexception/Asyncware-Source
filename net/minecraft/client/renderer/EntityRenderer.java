...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void refreshPointedBlock(float partialTicks, float maxDistance)
    {
        Entity entity = this.mc.getRenderViewEntity();

        if (entity != null && this.mc.theWorld != null)
        {
            float bigHitReach = maxDistance+1.5f;
            float smallHitReach = maxDistance-1.5f;
            ...
            {
                if (d0 > smallHitReach)// @Jupiter: origin: 3.0D
                {
                    flag = true;
                }
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > smallHitReach)
            {
                this.pointedEntity = null;
