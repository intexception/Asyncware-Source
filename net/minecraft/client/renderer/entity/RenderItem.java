...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    {
        int r = (int) Asyncware.instance.settingsManager.getSettingByName("Glint R").getValDouble();
        int g = (int) Asyncware.instance.settingsManager.getSettingByName("Glint G").getValDouble();
        int b = (int) Asyncware.instance.settingsManager.getSettingByName("Glint B").getValDouble();
        boolean niggerBallsack = Asyncware.instance.settingsManager.getSettingByName("Rainbow Glint").getValBoolean();

        int color = new Color(r, g, b, 158).getRGB();
        int nigger = Colors.RGB();
        ...
        if(niggerBallsack){
            this.renderModel(model, nigger);
        } else{
            this.renderModel(model, new Color(255, 50, 50, 255).getRGB());
        }
        ...
        if(niggerBallsack){
            this.renderModel(model, Colors.darker(nigger, 0.2f));
        } else{
            this.renderModel(model, new Color(50, 50, 255, 255).getRGB());
        }
        GlStateManager.popMatrix();
