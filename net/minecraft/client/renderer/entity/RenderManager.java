...
import com.nquantum.event.impl.EventHeadRender;
...
public class RenderManager
{
    ...
    public Map<String, RenderPlayer> skinMap = Maps.<String, RenderPlayer>newHashMap();
    ...
    public boolean renderEntityStatic(Entity entity, float partialTicks, boolean p_147936_3_)
    {
        ...
        if (entity instanceof EntityPlayerSP) {
            ...
            EventHeadRender event = new EventHeadRender(player.rotationYawHead, player.rotationPitch);
            event.call();
            ...
            player.rotationYawHead = event.headYaw;
            player.prevRotationYawHead = event.headYaw;
            player.rotationPitch = event.headPitch;
            player.prevRotationPitch = event.headPitch;

            boolean result = this.doRenderEntity(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, partialTicks, p_147936_3_);
            player.rotationYawHead = oldYaw;
            player.prevRotationYawHead = oldPrevYaw;
    ...
    public void renderWitherSkull(Entity entityIn, float partialTicks)
    {
        ...
        Minecraft.getMinecraft().thePlayer.prevRotationYaw = 0;
       // Minecraft.getMinecraft().thePlayer.prevRotationYaw = 0;

        Minecraft.getMinecraft().thePlayer.prevRotationPitch = 0.0f;
    }
