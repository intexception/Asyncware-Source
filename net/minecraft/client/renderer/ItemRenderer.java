...
import com.nquantum.module.render.SwordAnimation;
...
public class ItemRenderer
{
    ...
    private void func_178104_a(AbstractClientPlayer clientPlayer, float p_178104_2_)
    {
        ...
        GlStateManager.translate(f3 * 0.6F, f3 * -0.6F, f3 * 0.0F);
    ...
    private void func_178098_a(float p_178098_1_, AbstractClientPlayer clientPlayer)
    {
        ...
        GlStateManager.scale(0.5F, 0.5F, 0.5F + f1 * 0.2F);
    }
            ...
            else if (abstractclientplayer.getItemInUseCount() > 0)
            {
                ...
                switch (enumaction)
                {
                    ...
                    case BLOCK:
                        ...
                        boolean flag = Asyncware.instance.moduleManager.getModuleByName("SwordAnimation").isToggled();
                        if(flag && SwordAnimation.animint == 1){
                            this.transformFirstPersonItem(f, 0.0F);
                            this.fan();
                            break;
                        }
                        if(flag && SwordAnimation.animint == 2) {
                            // float f8 = (float) Math.sin(Math.sqrt(f1) * Math.PI);
                        ...
                        if(flag && SwordAnimation.animint == 3){
                        ...
                        if(flag && SwordAnimation.animint == 4){
                        ...
                        if(flag && SwordAnimation.animint == 5) {
                            this.func_178096_b(f, 0.0F);
                           // GL11.glRotated((-f8 * -32.0F), (f8 / 2.0F), 0.0D, 7.0D);

                           GL11.glRotated((-f8 * 16.0F), 0.800000011920929D, (f8 / 2.0F), 0.0D);
                            this.func_178103_d();
                            break;
                        }
                        else{
