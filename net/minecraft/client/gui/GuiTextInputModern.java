...
public class GuiTextInputModern extends Gui
{
    ...
    public GuiTextInputModern(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = Asyncware.renderer.drawString(s1, (float)l, (float)i1, i, true);
            }
            ...
            {
                j1 = Asyncware.renderer.drawString(s.substring(j), (float)j1, (float)i1, i, true);
            }
            ...
            if (flag1)
            {
                ...
                {
                    Asyncware.renderer.drawString("_", (float)k1, (float)i1, i, true);
                }
            }
