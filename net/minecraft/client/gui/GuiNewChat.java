                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                if(Asyncware.instance.moduleManager.getModuleByName("BetterChat").isToggled()){
                                    Asyncware.verdana.drawString(s, i2, (j2 - 10.05f), 16777215 + (l1 << 24), true);
                                } else {

                                    this.mc.fontRendererObj.drawStringWithShadow(s, (float) i2 - 0.3f, (float) (j2 - 8), 16777215 + (l1 << 24));
                                }
