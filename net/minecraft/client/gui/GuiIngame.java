...
import com.nquantum.module.misc.NoScoreboard;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        EventRenderUI eventRenderUI = new EventRenderUI();
        eventRenderUI.call();
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        if(!Asyncware.instance.moduleManager.getModuleByName("NoScoreboard").isToggled()) {
            ...
            for (Object score10 : arraylist1) {
                ...
                if (k == arraylist1.size()) {
                    ...
                    GuiUtil.drawChromaStringAstolfo(s3, j + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, l - this.getFontRenderer().FONT_HEIGHT, true);
                    //  this.getFontRenderer().drawStringWithShadow(s3, j + i / 2 - this.getFontRenderer().getStringWidth(s3) / 2, l - this.getFontRenderer().FONT_HEIGHT, Colors.RGB());
                    // Asyncware.renderer.drawString("www.asyncware.wtf", j + i / 2 - 40, l + 113, Colors.Astolfo(100, 1.0f, 0.6f), false);
                }
