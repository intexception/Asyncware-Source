...
import com.nquantum.event.impl.EventRightClicked;
import com.nquantum.ui.other.GuiFirst;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    public void displayCrashReport(CrashReport crashReportIn)
    {
        ...
        {
            Bootstrap.printToSYSOUT("#@!@# Game NIGGERD! Crash report saved to: #@!@# " + crashReportIn.getFile());
            System.exit(-1);
        }
        else if (crashReportIn.saveToFile(file2))
        {
            Bootstrap.printToSYSOUT("#@!@# Game NIGGERD! Crash report saved to: #@!@# " + file2.getAbsolutePath());
            System.exit(-1);
        }
        else
        {
            Bootstrap.printToSYSOUT("#@?@# Game NIGGERD! Crash report could not be saved. #@?@#");
            System.exit(-2);
        }
    }
    ...
    {
        EventRightClicked eventRightClicked = new EventRightClicked();
        eventRightClicked.call();
    ...
    {
       // Asyncware.instance.discordRP.update("Playing alone on singleplayer", "Ingame");
        this.loadWorld((WorldClient)null);
        System.gc();
