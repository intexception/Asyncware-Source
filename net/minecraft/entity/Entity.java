...
import com.nquantum.module.movement.SafeWalk;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            double d4 = y;
            double d5 = z;
            boolean flag = this.onGround && (this.isSneaking() || Asyncware.instance.moduleManager.getModuleByName("SafeWalk").isToggled()) && this instanceof EntityPlayer;
            if (flag)
            {
                double d6;
