...
public abstract class BlockLiquid extends Block
{
    ...
    {
        if(Asyncware.instance.moduleManager.getModuleByName("Jesus").isToggled()){
            return AxisAlignedBB.fromBounds(pos.getX() + this.maxX, pos.getY() + this.maxY,  pos.getZ() + this.maxZ,pos.getX() + this.maxX, pos.getY() + this.maxY , pos.getZ() + this.maxZ);
