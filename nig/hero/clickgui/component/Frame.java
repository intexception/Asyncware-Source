package nig.hero.clickgui.component;
...
import nig.hero.clickgui.component.components.Button;
...
public class Frame {
	...
	public Frame(Category cat) {
		...
		for(Module mod : Asyncware.instance.moduleManager.getModules(category)) {
	...
	public void renderFrame(FontRenderer fontRenderer) {
		Gui.drawRect(this.x, this.y, this.x + this.width, this.y + this.barHeight, new Color(26, 25, 27, 255).getRGB());
		GL11.glPushMatrix();
